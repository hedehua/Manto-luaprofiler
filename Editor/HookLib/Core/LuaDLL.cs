...
#pragma warning restore 0169
    ...
    public class LuaDLL
    {
        ...
        */
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate int luaL_error_fun(IntPtr L, string message);
        public static luaL_error_fun luaL_error;
...
";
        ...
        public static void BindEasyHook()
        {
            ...
            {
                IntPtr handle = GetProcAddress(moduleName, "lua_sethook");
                if (handle != IntPtr.Zero) 
                {
                    lua_sethook = (lua_sethook_fun)Marshal.GetDelegateForFunctionPointer(handle, typeof(lua_sethook_fun));
                }
            }
            ...
            
            {
                ...
                IntPtr handle = GetProcAddress(moduleName, "luaL_error");
                if (handle != IntPtr.Zero)
                {
                    luaL_error = (luaL_error_fun)Marshal.GetDelegateForFunctionPointer(handle, typeof(luaL_error_fun));
                }
            }
        ...
        public static void HookLoadLibrary()
        {
            ...
            {
                handle = GetProcAddress("user32.dll", "wsprintf");
                if (handle != IntPtr.Zero)
                {
                    wsprintf = (wsprintf_fun)Marshal.GetDelegateForFunctionPointer(handle, typeof(wsprintf_fun));
                }
